  ...
  return (
    <div className="w-full text-white">
      ...
      <div
        ...
        className="pointer-events-auto z-[55] pl-[calc(2rem+env(safe-area-inset-left))] pr-[calc(2rem+env(safe-area-inset-right))] pb-3 mb-[env(safe-area-inset-bottom)] absolute bottom-0 w-full"
      >
